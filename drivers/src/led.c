...
#endif
static GPIO_TypeDef* led_port[] = {LED_GPIO_PORT, LED_GPIO_PORT};
static unsigned int led_pin[] = { LED_GPIO_GREEN, LED_GPIO_RED };
static int led_polarity[] = { LED_POL_GREEN, LED_POL_RED };
