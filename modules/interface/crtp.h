...
#define CRTP_IS_NULL_PACKET(P) ((P.crtp_header&0xF3)==0xF3)
...
#pragma pack()
/*#define crtp_size s1.size*/
#define crtp_header s1.s2.s3.header
#define crtp_data s1.s2.data
#define crtp_port s1.s2.s3.s4.port
#define crtp_channel s1.s2.s3.s4.channel
