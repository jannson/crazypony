...
static void eskylinkDecode(char* packet)
{
  ...
  crtpPacket.crtp_port = CRTP_PORT_COMMANDER;
  memcpy(&crtpPacket.crtp_data[0],  (char*)&roll,   4);
  memcpy(&crtpPacket.crtp_data[4],  (char*)&pitch,  4);
  memcpy(&crtpPacket.crtp_data[8],  (char*)&yaw,    4);
  memcpy(&crtpPacket.crtp_data[12], (char*)&thrust, 2);
